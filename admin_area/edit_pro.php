...
<form method="post" action="" enctype="multipart/form-data">
	...
	<table width="790" align="center" border="1"  bgcolor="#999999">
        ...
        <td><input type="file" name="product_img1" /><img src="product_images/<?php echo $p_image1;?>" width="80" height="80"/></td>
        </tr>
        ...
        <td><input type="file" name="product_img3" /><img src="product_images/<?php echo $p_image3;?>" width="80" height="80"/></td>
        </tr>
...
<?php
	...
	if($title=='' OR $cat=='' OR $brand=='' OR $price=='' OR $desc=='' OR $keyword=='' OR $img1==''){
	 ...
	 move_uploaded_file($temp_name3,"product_images/$img3");
	  ...
	  $update_product = "update products set cat_id='$cat_id', brand_id='$brand_id',  product_title = '$p_title', product_img1='$p_image1', product_img3='$p_image3',
	   product_price='$p_price', product_desc='$p_desc', product_keywords='$p_keywords' where product_id ='$update_id'";  
