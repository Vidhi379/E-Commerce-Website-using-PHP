...
<?php
	...
	if($title=='' OR $cat=='' OR $brand=='' OR $price=='' OR $desc=='' OR $keyword=='' OR $img1==''){
	 ...
	 move_uploaded_file($temp_name3,"product_images/$img3");
	  ...
	  $mysqli = ("insert into products(cat_id,brand_id,product_title,product_img1,product_img3,product_price,product_desc) values('$cat',
	                  '$brand','$title','$img1','$img3','$price','$desc')");
