	...
	if(!isset ($_GET['my_orders'])){
		if(!isset ($_GET['edit_account'])){
			if(!isset ($_GET['change_pass'])){
				...
				<h3>Please see your order details by clicking this <a href='my_account.php?my_orders'>LINK</a><br> Or you can <a href='pay_offline.php' target='_blank'>Pay Offline Now</a></h3>
				...
				<h3>You can  see your order history by clicking this <a href='my_account.php?my_orders'>LINK</a></h3>
